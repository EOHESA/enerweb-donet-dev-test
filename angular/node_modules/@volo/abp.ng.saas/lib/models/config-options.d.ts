...
export declare type SaasEntityActionContributors = Partial<{
...
export declare type SaasToolbarActionContributors = Partial<{
...
export declare type SaasEntityPropContributors = Partial<{
...
export declare type SaasCreateFormPropContributors = Partial<{
...
export declare type SaasEditFormPropContributors = Partial<{
