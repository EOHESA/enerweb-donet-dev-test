    ...
    ***************************************************************************** */
    ...
    var ValidationDirective = /** @class */ (function (_super) {
        ...
        Object.defineProperty(ValidationDirective.prototype, "validation$", {
             ...
             */
            function () {
                return rxjs.merge(this.parent.getStream('status').pipe(operators.mapTo(null)), this.parent.getStream('value').pipe(operators.mapTo(null)), this.validateOnSubmit ? this.parent.getStream('submit') : rxjs.NEVER);
            },
            enumerable: true,
            configurable: true
        });
        ...
        function () {
             ...
             * @return {?}
             */
            function () { return !_this.skipValidation; })), operators.map((/**
             * @param {?} form
             * @return {?}
             */
    ...
    exports.ɵa = ValidationGroupDirective;
    exports.ɵb = AbstractValidationDirective;
    exports.ɵc = ValidationStyleDirective;
    exports.ɵd = ValidationTargetDirective;
    exports.ɵe = ValidationDirective;
    exports.ɵf = ValidationErrorComponent;
    exports.ɵg = AbstractValidationDirective;
    exports.ɵh = VALIDATION_BLUEPRINTS;
    exports.ɵi = BLUEPRINTS;
    exports.ɵj = VALIDATION_ERROR_TEMPLATE;
    exports.ɵk = VALIDATION_INVALID_CLASSES;
    exports.ɵl = VALIDATION_MAP_ERRORS_FN;
    exports.ɵm = defaultMapErrorsFn;
    exports.ɵn = VALIDATION_TARGET_SELECTOR;
    exports.ɵo = VALIDATION_VALIDATE_ON_SUBMIT;
