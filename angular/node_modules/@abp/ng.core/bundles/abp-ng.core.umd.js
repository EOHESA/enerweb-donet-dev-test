(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@abp/ng.core', ['exports', '@angular/core', '@angular/router', 'rxjs/operators', '@angular/common', 'rxjs', '@angular/common/http', '@ngxs/store', 'just-compare', 'snq', '@angular/forms', 'angular-oauth2-oidc', 'just-clone'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.abp = global.abp || {}, global.abp.ng = global.abp.ng || {}, global.abp.ng.core = {}), global.ng.core, global.ng.router, global.rxjs.operators, global.ng.common, global.rxjs, global.ng.common.http, global.i4, global.compare, global.snq, global.ng.forms, global.i1$1, global.clone));
}(this, (function (exports, i0, i1, operators, common, rxjs, i2, i4, compare, snq, forms, i1$1, clone) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var EnvironmentService = /** @class */ (function () {
        ...
        EnvironmentService.prototype.getApiUrl$ = function (key) {
            return this.store
                .sliceState(function (state) { return state.apis; })
                .pipe(operators.map(function (apis) { return (apis[key || 'default'] || apis.default).url; }));
        };
    ...
    var LocalizationService = /** @class */ (function () {
        function LocalizationService(sessionState, injector, ngZone, otherInstance, configState, appConfigService) {
        ...
        LocalizationService.prototype.listenToSetLanguage = function () {
            ...
            this.sessionState
                ...
                .pipe(operators.mapTo(lang)); }))
                .subscribe(function (lang) {
                _this.registerLocale(lang);
                _this._languageChange$.next(lang);
            });
        };
    ...
    LocalizationService.ɵprov = i0.ɵɵdefineInjectable({ factory: function LocalizationService_Factory() { return new LocalizationService(i0.ɵɵinject(SessionStateService), i0.ɵɵinject(i0.INJECTOR), i0.ɵɵinject(i0.NgZone), i0.ɵɵinject(LocalizationService, 12), i0.ɵɵinject(ConfigStateService), i0.ɵɵinject(AbpApplicationConfigurationService)); }, token: LocalizationService, providedIn: "root" });
    ...
    var DynamicLayoutComponent = /** @class */ (function () {
        function DynamicLayoutComponent(injector, localizationService, replaceableComponents, subscription, dynamicLayoutComponent) {
            ...
            this.getLayout();
            this.subscription.addOne(this.router.events.pipe(operators.filter(function (event) { return event instanceof i1.NavigationEnd; })), function () {
                _this.getLayout();
            });
    ...
    var ApiInterceptor = /** @class */ (function () {
        function ApiInterceptor(oAuthService, sessionState, httpWaitService) {
            this.oAuthService = oAuthService;
            this.sessionState = sessionState;
    ...
    ApiInterceptor.ɵprov = i0.ɵɵdefineInjectable({ factory: function ApiInterceptor_Factory() { return new ApiInterceptor(i0.ɵɵinject(i1$1.OAuthService), i0.ɵɵinject(SessionStateService), i0.ɵɵinject(HttpWaitService)); }, token: ApiInterceptor, providedIn: "root" });
    ...
    var AuthService = /** @class */ (function () {
        function AuthService(environment, injector) {
            var _this = this;
            this.environment = environment;
            this.injector = injector;
            this.setStrategy = function () {
                ...
                _this.flow = flow;
                _this.strategy = AUTH_FLOW_STRATEGY.Code(_this.injector);
            };
            this.setStrategy();
            this.listenToSetEnvironment();
        }
    ...
    AuthService.ɵprov = i0.ɵɵdefineInjectable({ factory: function AuthService_Factory() { return new AuthService(i0.ɵɵinject(EnvironmentService), i0.ɵɵinject(i0.INJECTOR)); }, token: AuthService, providedIn: "root" });
    ...
    var AbpTenantService = /** @class */ (function () {
        function AbpTenantService(restService) {
            ...
            this.restService = restService;
            this.apiName = 'abp';
            this.findTenantById = function (id) { return _this.restService.request({
                method: 'GET',
    ...
    var MultiTenancyService = /** @class */ (function () {
        function MultiTenancyService(restService, sessionState) {
            this.restService = restService;
            this.sessionState = sessionState;
    ...
    MultiTenancyService.ɵprov = i0.ɵɵdefineInjectable({ factory: function MultiTenancyService_Factory() { return new MultiTenancyService(i0.ɵɵinject(RestService), i0.ɵɵinject(SessionStateService)); }, token: MultiTenancyService, providedIn: "root" });
    ...
    function parseTenantFromUrl(injector) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var environmentService, multiTenancyService, abpTenantService, baseUrl, tenancyName;
            return __generator(this, function (_c) {
                environmentService = injector.get(EnvironmentService);
                multiTenancyService = injector.get(MultiTenancyService);
                abpTenantService = injector.get(AbpTenantService);
                ...
                if (tenancyName) {
                    ...
                    return [2 /*return*/, rxjs.of(null)
                            .pipe(operators.switchMap(function () { return abpTenantService.findTenantByName(tenancyName, { __tenant: '' }); }), operators.tap(function (res) {
    ...
    var RouterWaitService = /** @class */ (function () {
        function RouterWaitService(router, injector) {
            var _this = this;
            this.router = router;
            ...
            this.router.events
                ...
                event instanceof i1.NavigationCancel; }), operators.map(function (event) { return event instanceof i1.NavigationStart; }), operators.switchMap(function (condition) { return condition
                ? _this.delay === 0
                    ? rxjs.of(true)
    ...
    exports.ɵbm = HttpWaitService;
    exports.ɵbn = OAuthConfigurationHandler;
    exports.ɵbo = noop;
    exports.ɵbp = getInitialData;
    exports.ɵbq = localeInitializer;
    exports.ɵbr = RoutesHandler;
    exports.ɵbs = AbstractTreeService;
    exports.ɵbt = AbstractNavTreeService;
    exports.ɵbu = RoutesService;
