import { ChangeDetectorRef, Component, Injector, Input, InjectionToken, ɵɵdefineInjectable, Injectable, ɵɵinject, Inject, INJECTOR, NgZone, Optional, SkipSelf, isDevMode, Directive, ElementRef, EventEmitter, Output, HostBinding, TemplateRef, ViewContainerRef, IterableDiffers, Self, Renderer2, ComponentFactoryResolver, Pipe, NgModule, LOCALE_ID, APP_INITIALIZER, NgModuleFactory, Compiler, ApplicationRef } from '@angular/core';
import { Router, PRIMARY_OUTLET, ActivatedRoute, NavigationEnd, RouterModule, NavigationStart, NavigationError, NavigationCancel } from '@angular/router';
import { map, distinctUntilChanged, filter, catchError, take, switchMap, tap, mapTo, debounceTime, takeUntil, finalize, retryWhen, delay, shareReplay } from 'rxjs/operators';
import { __rest, __awaiter, __decorate } from 'tslib';
import { registerLocaleData, CommonModule } from '@angular/common';
import { BehaviorSubject, Subject, throwError, noop as noop$1, Subscription, fromEvent, of, timer, Observable, concat, ReplaySubject } from 'rxjs';
...
EnvironmentService.ɵprov = ɵɵdefineInjectable({ factory: function EnvironmentService_Factory() { return new EnvironmentService(); }, token: EnvironmentService, providedIn: "root" });
...
RestService.ɵprov = ɵɵdefineInjectable({ factory: function RestService_Factory() { return new RestService(ɵɵinject(CORE_OPTIONS), ɵɵinject(HttpClient), ɵɵinject(EnvironmentService), ɵɵinject(Store)); }, token: RestService, providedIn: "root" });
...
ConfigStateService.ɵprov = ɵɵdefineInjectable({ factory: function ConfigStateService_Factory() { return new ConfigStateService(); }, token: ConfigStateService, providedIn: "root" });
...
SessionStateService.ɵprov = ɵɵdefineInjectable({ factory: function SessionStateService_Factory() { return new SessionStateService(ɵɵinject(ConfigStateService)); }, token: SessionStateService, providedIn: "root" });
...
LocalizationService.ɵprov = ɵɵdefineInjectable({ factory: function LocalizationService_Factory() { return new LocalizationService(ɵɵinject(SessionStateService), ɵɵinject(INJECTOR), ɵɵinject(NgZone), ɵɵinject(LocalizationService, 12), ɵɵinject(ConfigStateService), ɵɵinject(AbpApplicationConfigurationService)); }, token: LocalizationService, providedIn: "root" });
...
PermissionService.ɵprov = ɵɵdefineInjectable({ factory: function PermissionService_Factory() { return new PermissionService(ɵɵinject(ConfigStateService)); }, token: PermissionService, providedIn: "root" });
...
RoutesService.ɵprov = ɵɵdefineInjectable({ factory: function RoutesService_Factory() { return new RoutesService(ɵɵinject(INJECTOR)); }, token: RoutesService, providedIn: "root" });
RoutesService.decorators = [
    { type: Injectable, args: [{ providedIn: 'root' },] }
];
class SettingTabsService extends AbstractNavTreeService {
}
SettingTabsService.ɵprov = ɵɵdefineInjectable({ factory: function SettingTabsService_Factory() { return new SettingTabsService(ɵɵinject(INJECTOR)); }, token: SettingTabsService, providedIn: "root" });
...
OAuthConfigurationHandler.ɵprov = ɵɵdefineInjectable({ factory: function OAuthConfigurationHandler_Factory() { return new OAuthConfigurationHandler(ɵɵinject(OAuthService), ɵɵinject(EnvironmentService), ɵɵinject(CORE_OPTIONS)); }, token: OAuthConfigurationHandler, providedIn: "root" });
...
HttpWaitService.ɵprov = ɵɵdefineInjectable({ factory: function HttpWaitService_Factory() { return new HttpWaitService(ɵɵinject(INJECTOR)); }, token: HttpWaitService, providedIn: "root" });
...
ApiInterceptor.ɵprov = ɵɵdefineInjectable({ factory: function ApiInterceptor_Factory() { return new ApiInterceptor(ɵɵinject(OAuthService), ɵɵinject(SessionStateService), ɵɵinject(HttpWaitService)); }, token: ApiInterceptor, providedIn: "root" });
...
AuthService.ɵprov = ɵɵdefineInjectable({ factory: function AuthService_Factory() { return new AuthService(ɵɵinject(EnvironmentService), ɵɵinject(INJECTOR)); }, token: AuthService, providedIn: "root" });
...
MultiTenancyService.ɵprov = ɵɵdefineInjectable({ factory: function MultiTenancyService_Factory() { return new MultiTenancyService(ɵɵinject(RestService), ɵɵinject(SessionStateService)); }, token: MultiTenancyService, providedIn: "root" });
...
AuthGuard.ɵprov = ɵɵdefineInjectable({ factory: function AuthGuard_Factory() { return new AuthGuard(ɵɵinject(OAuthService), ɵɵinject(AuthService)); }, token: AuthGuard, providedIn: "root" });
...
PermissionGuard.ɵprov = ɵɵdefineInjectable({ factory: function PermissionGuard_Factory() { return new PermissionGuard(ɵɵinject(Router), ɵɵinject(RoutesService), ɵɵinject(Store), ɵɵinject(PermissionService)); }, token: PermissionGuard, providedIn: "root" });
...
ApplicationConfigurationService.ɵprov = ɵɵdefineInjectable({ factory: function ApplicationConfigurationService_Factory() { return new ApplicationConfigurationService(ɵɵinject(RestService)); }, token: ApplicationConfigurationService, providedIn: "root" });
...
ResourceWaitService.ɵprov = ɵɵdefineInjectable({ factory: function ResourceWaitService_Factory() { return new ResourceWaitService(); }, token: ResourceWaitService, providedIn: "root" });
...
LazyLoadService.ɵprov = ɵɵdefineInjectable({ factory: function LazyLoadService_Factory() { return new LazyLoadService(ɵɵinject(ResourceWaitService)); }, token: LazyLoadService, providedIn: "root" });
...
RouterWaitService.ɵprov = ɵɵdefineInjectable({ factory: function RouterWaitService_Factory() { return new RouterWaitService(ɵɵinject(Router), ɵɵinject(INJECTOR)); }, token: RouterWaitService, providedIn: "root" });
...
export { AUTH_FLOW_STRATEGY, AbpApiDefinitionService, AbpApplicationConfigurationService, AbpTenantService, AbpValidators, AbstractNavTreeService, AbstractNgModelComponent, AbstractTreeService, ApiInterceptor, ApplicationConfigurationService, AuditedEntityDto, AuditedEntityWithUserDto, AuthCodeFlowStrategy, AuthFlowStrategy, AuthGuard, AuthService, AutofocusDirective, BaseCoreModule, BaseTreeNode, CONTAINER_STRATEGY, CONTENT_SECURITY_STRATEGY, CONTENT_STRATEGY, CONTEXT_STRATEGY, CORE_OPTIONS, CROSS_ORIGIN_STRATEGY, ChangePassword, ClearContainerStrategy, ComponentContextStrategy, ComponentProjectionStrategy, ConfigState, ConfigStateService, ContainerStrategy, ContentProjectionService, ContentSecurityStrategy, ContentStrategy, ContextStrategy, CoreModule, CreationAuditedEntityDto, CreationAuditedEntityWithUserDto, CrossOriginStrategy, DOM_STRATEGY, DomInsertionService, DomStrategy, DynamicLayoutComponent, EllipsisDirective, EntityDto, EnvironmentService, ExtensibleAuditedEntityDto, ExtensibleAuditedEntityWithUserDto, ExtensibleCreationAuditedEntityDto, ExtensibleCreationAuditedEntityWithUserDto, ExtensibleEntityDto, ExtensibleFullAuditedEntityDto, ExtensibleFullAuditedEntityWithUserDto, ExtensibleObject, ForDirective, FormSubmitDirective, FullAuditedEntityDto, FullAuditedEntityWithUserDto, GetAppConfiguration, GetProfile, HttpWaitService, InitDirective, InputEventDebounceDirective, InsertIntoContainerStrategy, InternalStore, LIST_QUERY_DEBOUNCE_TIME, LOADER_DELAY, LOADING_STRATEGY, LazyLoadService, LazyModuleFactory, LimitedResultRequestDto, ListResultDto, ListService, LoadingStrategy, LocalizationModule, LocalizationPipe, LocalizationService, LooseContentSecurityStrategy, MultiTenancyService, NoContentSecurityStrategy, NoContextStrategy, index as ObjectExtending, PROJECTION_STRATEGY, PagedAndSortedResultRequestDto, PagedResultDto, PagedResultRequestDto, PermissionDirective, PermissionGuard, PermissionService, ProfileService, ProfileState, ProfileStateService, ProjectionStrategy, ReplaceableComponentsService, ReplaceableRouteContainerComponent, ReplaceableTemplateDirective, ResourceWaitService, RestOccurError, RestService, RootComponentProjectionStrategy, RootCoreModule, RouterOutletComponent, RouterWaitService, RoutesService, ScriptContentStrategy, ScriptLoadingStrategy, SessionStateService, SetEnvironment, SettingTabsService, SortPipe, StartLoader, StopLoader, StopPropagationDirective, StyleContentStrategy, StyleLoadingStrategy, SubscriptionService, TemplateContextStrategy, TemplateProjectionStrategy, TrackByService, UpdateProfile, VisibilityDirective, checkAccessToken, clearOAuthStorage, coreOptionsFactory, createLocalizationPipeKeyGenerator, createLocalizer, createLocalizerWithFallback, createMapFromList, createTokenParser, createTreeFromList, deepMerge, differentLocales, downloadBlob, exists, findRoute, fromLazyLoad, generateHash, generatePassword, getInitialData, getLocaleDirection, getPathName, getRemoteEnv, getRoutePath, getShortDateFormat, getShortDateShortTimeFormat, getShortTimeFormat, interpolate, isArray, isNode, isNullOrUndefined, isNumber, isObject, isObjectAndNotArray, isObjectAndNotArrayNotNode, isUndefinedOrEmptyString, localeInitializer, mapEnumToOptions, ngxsStoragePluginSerialize, noop, oAuthStorage, parseTenantFromUrl, pushValueTo, reloadRoute, storageFactory, takeUntilDestroy, trackBy, trackByDeep, uuid, validateCreditCard, validateMinAge, validateRange, validateRequired, validateStringLength, validateUrl, ɵ0, oAuthStorage as ɵa, LocalizationPipe as ɵb, SortPipe as ɵba, StopPropagationDirective as ɵbb, VisibilityDirective as ɵbc, ProfileState as ɵbd, ProfileService as ɵbe, GetProfile as ɵbf, UpdateProfile as ɵbg, ChangePassword as ɵbh, LocaleId as ɵbj, LocaleProvider as ɵbk, ApiInterceptor as ɵbl, HttpWaitService as ɵbm, OAuthConfigurationHandler as ɵbn, noop as ɵbo, getInitialData as ɵbp, localeInitializer as ɵbq, RoutesHandler as ɵbr, AbstractTreeService as ɵbs, AbstractNavTreeService as ɵbt, RoutesService as ɵbu, LocalizationService as ɵc, SessionStateService as ɵd, ConfigStateService as ɵe, AbpApplicationConfigurationService as ɵf, RestService as ɵg, CORE_OPTIONS as ɵh, coreOptionsFactory as ɵi, EnvironmentService as ɵk, AbstractNgModelComponent as ɵl, AutofocusDirective as ɵm, DynamicLayoutComponent as ɵn, SubscriptionService as ɵo, ReplaceableComponentsService as ɵp, EllipsisDirective as ɵq, ForDirective as ɵr, FormSubmitDirective as ɵs, InitDirective as ɵt, InputEventDebounceDirective as ɵu, PermissionDirective as ɵv, PermissionService as ɵw, ReplaceableRouteContainerComponent as ɵx, ReplaceableTemplateDirective as ɵy, RouterOutletComponent as ɵz };
