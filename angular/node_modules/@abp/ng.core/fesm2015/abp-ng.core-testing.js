...
MockPermissionService.ɵprov = ɵɵdefineInjectable({ factory: function MockPermissionService_Factory() { return new MockPermissionService(ɵɵinject(ConfigStateService)); }, token: MockPermissionService, providedIn: "root" });
...
MockRestService.ɵprov = ɵɵdefineInjectable({ factory: function MockRestService_Factory() { return new MockRestService(ɵɵinject(CORE_OPTIONS), ɵɵinject(HttpClient), ɵɵinject(EnvironmentService)); }, token: MockRestService, providedIn: "root" });
