...
export declare class LocalizationService {
    ...
    constructor(sessionState: SessionStateService, injector: Injector, ngZone: NgZone, otherInstance: LocalizationService, configState: ConfigStateService, appConfigService: AbpApplicationConfigurationService);
