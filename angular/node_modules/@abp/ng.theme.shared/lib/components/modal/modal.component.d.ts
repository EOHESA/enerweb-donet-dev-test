...
export declare class ModalComponent implements OnDestroy {
    ...
    constructor(renderer: Renderer2, confirmationService: ConfirmationService, modalService: ModalService, subscription: SubscriptionService, suppressUnsavedChangesWarningToken: boolean);
