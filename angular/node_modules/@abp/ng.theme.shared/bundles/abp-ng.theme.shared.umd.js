(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/animations'), require('@abp/ng.core'), require('@angular/core'), require('@angular/router'), require('rxjs/operators'), require('rxjs'), require('snq'), require('@angular/common'), require('@swimlane/ngx-datatable'), require('just-clone'), require('@angular/common/http'), require('@ngxs/store'), require('@ng-bootstrap/ng-bootstrap'), require('@ngx-validate/core'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('@abp/ng.theme.shared', ['exports', '@angular/animations', '@abp/ng.core', '@angular/core', '@angular/router', 'rxjs/operators', 'rxjs', 'snq', '@angular/common', '@swimlane/ngx-datatable', 'just-clone', '@angular/common/http', '@ngxs/store', '@ng-bootstrap/ng-bootstrap', '@ngx-validate/core', '@angular/forms'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.abp = global.abp || {}, global.abp.ng = global.abp.ng || {}, global.abp.ng.theme = global.abp.ng.theme || {}, global.abp.ng.theme.shared = {}), global.ng.animations, global.i1, global.ng.core, global.ng.router, global.rxjs.operators, global.rxjs, global.snq, global.ng.common, global.ngxDatatable, global.clone, global.ng.common.http, global.i1$1, global.ngBootstrap, global.core, global.ng.forms));
}(this, (function (exports, animations, i1, i0, i2, operators, rxjs, snq, common, ngxDatatable, clone, http, i1$1, ngBootstrap, core, forms) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var BreadcrumbComponent = /** @class */ (function () {
        ...
        BreadcrumbComponent.prototype.ngOnInit = function () {
            var _this = this;
            this.subscription.addOne(this.router.events.pipe(operators.filter(function (event) { return event instanceof i2.NavigationEnd; }), 
    ...
    var ModalComponent = /** @class */ (function () {
        function ModalComponent(renderer, confirmationService, modalService, subscription, suppressUnsavedChangesWarningToken) {
            this.renderer = renderer;
    ...
    var ErrorHandler = /** @class */ (function () {
        function ErrorHandler(actions, router, confirmationService, cfRes, rendererFactory, injector, httpErrorConfig) {
            var _this = this;
        ...
        ErrorHandler.prototype.listenToRouterError = function () {
            var _this = this;
            this.router.events
                .pipe(operators.filter(function (event) { return event instanceof i2.NavigationError; }), operators.filter(this.filterRouteErrors))
                .subscribe(function () { return _this.show404Page(); });
        };
        ErrorHandler.prototype.listenToRouterDataResolved = function () {
            var _this = this;
            this.router.events
                .pipe(operators.filter(function (event) { return event instanceof i2.ResolveEnd; }), operators.filter(function () { return !!_this.componentRef; }))
                .subscribe(function () {
        ...
        ErrorHandler.prototype.navigateToLogin = function () {
            this.injector.get(i1.AuthService).initLogin();
        };
    ...
    ErrorHandler.ɵprov = i0.ɵɵdefineInjectable({ factory: function ErrorHandler_Factory() { return new ErrorHandler(i0.ɵɵinject(i1$1.Actions), i0.ɵɵinject(i2.Router), i0.ɵɵinject(ConfirmationService), i0.ɵɵinject(i0.ComponentFactoryResolver), i0.ɵɵinject(i0.RendererFactory2), i0.ɵɵinject(i0.INJECTOR), i0.ɵɵinject("HTTP_ERROR_CONFIG")); }, token: ErrorHandler, providedIn: "root" });
    ...
    BaseThemeSharedModule.decorators = [
        { type: i0.NgModule, args: [{
                    ...
                    exports: __spread([ngxDatatable.NgxDatatableModule], declarationsWithExports),
    ...
    exports.ɵba = ErrorHandler;
    exports.ɵbc = THEME_SHARED_ROUTE_PROVIDERS;
    exports.ɵbd = configureRoutes;
    exports.ɵbe = THEME_SHARED_APPEND_CONTENT;
    exports.ɵbf = initLazyStyleHandler;
    exports.ɵbg = httpErrorConfigFactory;
    exports.ɵbh = HTTP_ERROR_CONFIG;
    exports.ɵbi = DateParserFormatter;
    exports.ɵc = ChartComponent;
    exports.ɵd = ConfirmationComponent;
    exports.ɵe = LoaderBarComponent;
    exports.ɵf = LoadingComponent;
    exports.ɵg = ModalComponent;
    exports.ɵh = fadeAnimation;
    exports.ɵi = fadeIn;
    exports.ɵj = fadeOut;
    exports.ɵk = ModalService;
    exports.ɵl = SUPPRESS_UNSAVED_CHANGES_WARNING;
    ...
    exports.ɵu = NgxDatatableDefaultDirective;
    exports.ɵv = NgxDatatableListDirective;
    exports.ɵw = LoadingDirective;
    exports.ɵx = TableSortDirective;
    exports.ɵy = HttpErrorWrapperComponent;
    exports.ɵz = ModalContainerComponent;
