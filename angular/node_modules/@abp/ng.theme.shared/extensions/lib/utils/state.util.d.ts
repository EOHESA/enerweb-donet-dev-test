...
export declare function getObjectExtensionEntitiesFromStore(configState: ConfigStateService, moduleKey: string): Observable<Record<string, ObjectExtensions.EntityExtensionDto>>;
