(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@abp/ng.core'), require('@abp/ng.theme.shared'), require('@angular/core'), require('@ng-bootstrap/ng-bootstrap'), require('@ngxs/store'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@abp/ng.feature-management', ['exports', '@abp/ng.core', '@abp/ng.theme.shared', '@angular/core', '@ng-bootstrap/ng-bootstrap', '@ngxs/store', 'rxjs/operators'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.abp = global.abp || {}, global.abp.ng = global.abp.ng || {}, global.abp.ng['feature-management'] = {}), global.i1, global.ng_theme_shared, global.ng.core, global.ngBootstrap, global.store, global.rxjs.operators));
}(this, (function (exports, i1, ng_theme_shared, i0, ngBootstrap, store, operators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    FeatureManagementModule.decorators = [
        { type: i0.NgModule, args: [{
                    ...
                    imports: [i1.CoreModule, ng_theme_shared.ThemeSharedModule, ngBootstrap.NgbNavModule, store.NgxsModule.forFeature([])],
